                                                ...
                                                switch (
                                                    ...
                                                    case 8:
                                                        ...
                                                        curPage =
                                                            page === '/'
                                                                ? 'index'
                                                                : page // webpack 5 uses an array instead

                                                        pageUpdated = (Array.isArray(
                                                            jsonData.c
                                                        )
                                                            ? jsonData.c
                                                            : Object.keys(
                ...
                /* WEBPACK VAR INJECTION */ ;(function (module) {
                    ...
                    TextDecoderPolyfill.prototype.decode = function (octets) {
                        function valid(codePoint, shift, octetsCount) {
                            if (octetsCount === 1) {
                                return (
                                    codePoint >= 0x0080 >> shift &&
                                    codePoint << shift <= 0x07ff
                                )
                            }
                            ...
                            if (octetsCount === 2) {
                                return (
                                    ...
                                    (codePoint >= 0xe000 >> shift &&
                                        codePoint << shift <= 0xffff)
                                )
                            }
                            ...
                            if (bitsNeeded === 0) {
                                if (codePoint <= 0xffff) {
                                    ...
                                    string += String.fromCharCode(
                                        0xd800 +
                                            ((codePoint - 0xffff - 1) >> 10)
                                    )
                                    string += String.fromCharCode(
                                        0xdc00 +
                                            ((codePoint - 0xffff - 1) & 0x3ff)
                                    )
                                }
                            }
                        }
                            ...
                            if (state === 1) {
                                ...
                                if (!('contentType' in xhr)) {
                                    try {
                                        ...
                                        contentType = xhr.getResponseHeader(
                                            'Content-Type'
                                        )
                                    } catch (error) {
                    ...
                    XHRWrapper.prototype.setRequestHeader = function (
                        name,
                        value
                    ) {
                        var xhr = this._xhr
                    ...
                    EventSourcePolyfill.prototype = Object.create(
